...
COLLECTION_TYPES = (syntax.TBag, syntax.TSet, syntax.TList, target_syntax.TArray)
def is_collection(t):
...
class Typechecker(Visitor):
    ...
    def visit_ESorted(self, e):
        ...
        self.visit(e.asc)
        e.type = syntax.TList(self.get_collection_type(e.e))
